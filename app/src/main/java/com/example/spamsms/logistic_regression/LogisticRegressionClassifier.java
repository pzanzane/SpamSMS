package com.example.spamsms.logistic_regression;
...
{   
    ...
    public void train(String lingMessageFolderName, String spamMessageFolderName ,
                      String[] lingFilePath , String[] spamFilePath,
                      AssetManager assetManager) {
        // Open all messages and store the distinct words.
        openMessages(lingMessageFolderName, lingFilePath, assetManager);
        openMessages(spamMessageFolderName, spamFilePath, assetManager);
        ...
        {          
            trainMessages(lingMessageFolderName, lingFilePath,assetManager,0,s);

            trainMessages(spamMessageFolderName, spamFilePath, assetManager,1,s_new);
    ...
    public void openMessages(String directoryName,String[] assetFileRelativePath, AssetManager assetManager)
    {
    	try
    	{

            Log.d("WASTE","Started");
            for(String assetName: assetFileRelativePath){

                String name = !TextUtils.isEmpty(directoryName) ? directoryName+"/"+assetName: assetName;
    ...
    public void trainMessages (String directoryName,String[] assetFileRelativePath, AssetManager assetManager, int category,double mys)
    {
        try
        {
    ...
    private double computeInnerProduct(HashSet<String> WordOccurrences,Map<String, Double> WeightedWords)
    {
     ...
     //Return: true if message is a SPAM
